      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="font-sans text-[9px] tracking-[0.35em] text-[#C9A84C] uppercase mt-1 mb-6">
              Fine Jewellery
            </p>
            ...
            <div className="flex gap-4 mt-6">
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="text-[#5A5A5A] hover:text-[#C9A84C] transition-colors">
              ...
              {/* X / Twitter */}
              <a href="#" aria-label="X" className="text-[#5A5A5A] hover:text-[#C9A84C] transition-colors">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              {/* Facebook */}
              <a href="#" aria-label="Facebook" className="text-[#5A5A5A] hover:text-[#C9A84C] transition-colors">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Collections */}
          <div>
            <h4 className="font-sans text-[9px] tracking-[0.3em] text-[#C9A84C] uppercase mb-6">
              Collections
            </h4>
